/*
  # Triumvirate Mode Schema

  1. New Tables
    - `triumvirate_groups` - Stores group assignments for teams
    - `triumvirate_phases` - Stores phase information for tournaments
  2. Changes
    - Add triumvirate fields to tournaments table
...
-- Add policies for triumvirate_groups (only if they don't exist)
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'triumvirate_groups' AND policyname = 'Users can create triumvirate_groups'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'triumvirate_groups' AND policyname = 'Users can read triumvirate_groups'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'triumvirate_groups' AND policyname = 'Users can update triumvirate_groups'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'triumvirate_groups' AND policyname = 'Users can delete triumvirate_groups'
  ) THEN
...
-- Add policies for triumvirate_phases (only if they don't exist)
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'triumvirate_phases' AND policyname = 'Users can create triumvirate_phases'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'triumvirate_phases' AND policyname = 'Users can read triumvirate_phases'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'triumvirate_phases' AND policyname = 'Users can update triumvirate_phases'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'triumvirate_phases' AND policyname = 'Users can delete triumvirate_phases'
  ) THEN
